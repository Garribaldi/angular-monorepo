...
describe('DataGridColumnComponent', () => {
  ...
  const testDateFilter = new DateFilter({value: {from: null, to: null}, label: 'Date Label', column: currentColumn});
  ...
  describe('addFilter()', () => {
    ...
    beforeEach(() => spyOnAddFilter = jest.spyOn(selectedFilterServicec, 'addFilter'));
  ...
  describe('removeFilter()', () => {
    ...
    beforeEach(() => spyOnRemoveFilter = jest.spyOn(selectedFilterServicec, 'removeFilter'));
  ...
  describe('removeFilterByColumn()', () => {
    ...
    beforeEach(() => spyOnRemoveFilterByColumn = jest.spyOn(selectedFilterServicec, 'removeFilterByColumn'));
  ...
  describe('updateFilterByColumn()', () => {
    ...
    beforeEach(() => spyOnUpdateFilterByColumn = jest.spyOn(selectedFilterServicec, 'updateFilterByColumn'));

    it('should update filter for current column', () => {
      component.updateFilterByColumn(testDateFilter);

      expect(spyOnUpdateFilterByColumn).toHaveBeenCalledWith(testDateFilter, component.column);
    });
  });
});
