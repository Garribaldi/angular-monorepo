...
import { DatasourceService } from './utils/services/datasource.service';
import { PanelStateService } from './utils/services/panel-state.service';
import { SelectedFilterStateService } from './utils/services/selected-filter-state.service';
import { GroupedFilter } from './utils/models/grouped-filter.model';
import { Filter } from './utils/models/filter/filter.model';
...
export class DataGridComponent<T extends Record<string, unknown>> implements OnInit, OnDestroy {
  ...
  /**
   * If set to _true_, filter are always visible instead of embedded in an accordion
   */
  @Input() fixedDisplay = false;
